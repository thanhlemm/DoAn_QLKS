...
//             <Card.Body>
//               <Card.Title className="text-purple-600">Check Rooms Availibility</Card.Title>
//               <Form>
...
//                   </Form.Control>
//                 </Form.Group>
//                 <Link to={`/hotel/branch/${branch.id}/roomtype/roomselection/`} className="btn btn-primary btn-block" onClick={handleCheckAvailability}>
//                   Check Availability
//                 </Link>
//                 {/* <Button to={`/hotel/branch/${branch.id}/roomtype/roomselection/`} variant="primary" onClick={handleCheckAvailability}>Check Availability</Button> */}
//               </Form>
//             </Card.Body>
//           </Card>
//         </Col>
...
const BranchDetail = () => {
  ...
  const handleCheckAvailability = async (e) => {
    ...
    if (id && roomType && checkin && checkout) {
      try {
        await fetchAvailableRooms();
        navigate(`/hotel/branch/${id}/roomtype/roomselection`, {
